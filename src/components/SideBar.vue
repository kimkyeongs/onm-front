<template>
  <div class="side-wrap">
      ...
      <div class="menu">
        <ul>
          ...
          >
            <dl>
              <dt>
                <a href="#" title="depth1" @click="sideMenuEvent">
              ...
              <dd>
                <template v-if="menu.children">
                  <div class="depth2" v-if="idx !== 0">
                    <ul>
                      <li v-for="menu in menu.children" :key="menu.idx">
                        <a
                          href="#"
                          title="depth2"
                          @click="sideMenuEvent($event, menu.menuUrl)"
                        >
                          {{ menu.menuTitle }}
                          <i
                            v-if="menu.child"
                            class="icon icon-default icon-arrowDown-white"
                          />
                        </a>
                        <template v-if="menu.child">
                          <div class="depth3">
                            <ul>
                              <li v-for="menu in menu.child" :key="menu.idx">
                                <a
                                  href="#"
                                  title="depth3"
                                  @click="sideMenuEvent"
    ...
    <button type="button" class="btn-sideToggle blind" @click="sidebarToggle">
      sideToggle
    </button>
  </div>
</template>
...
.btn-sideToggle {
  ...
  top: 30px;
  right: 0;
  background: var(--color-orange) url("@/assets/images/icon-sideMenu@2x.png")
