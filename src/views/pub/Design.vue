...
import StatusData from '@/views/pub/components/StatusData'
...
// import ModalMobileSearch from '@/views/pub/components/moSearch/ModalMobileSearch'
import AgGrid from '@/views/pub/components/AgGrid'
