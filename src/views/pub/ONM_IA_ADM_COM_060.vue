<template>
  <section class="onmContent">
    <head-title title="개인정보 마스킹제거 모니터링" />
    <sub-title title="개인정보 마스킹제거 모니터링 상세보기" />
    <div class="table">
      <table>
        <caption class="sr-only">로그인 상세정보</caption>
        <colgroup>
          <col width="20%">
          <col width="30%">
          <col width="20%">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td></td>
            <th scope="row"><span>마스킹제거 일시</span></th>
            <td></td>
          </tr>
          <tr>
            <th scope="row"><span>마스킹제거 사용 위치</span></th>
            <td></td>
            <th scope="row"><span>IP주소</span></th>
            <td></td>
          </tr>
        </tbody>
      </table>
...
export default {
  ...
  data() {
    return {
      useGuideLists: [
        "- 이 페이지는 고객사 플랫폼 대표관리자가 사용자의 개인정보 마스킹제거 이력을 모니터링하는 페이지 입니다."
      ],
    }
  },
  computed: {
