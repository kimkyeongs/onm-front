    ...
    <div v-if="searchIsActive" class="searchArea mt-3 mb-5">
      <div class="row-form mb-3">
        ...
        <div class="col-lg-2 col-md-4">
          <v-select :items="items" class="selectBox" label="선택" dense solo />
        </div>
        <div class="col-lg-1 col-md-2">
        ...
        <div class="col-lg-2 col-md-4">
          <input type="text" class="form-control" placeholder="배치명" />
        </div>
        <div class="col-lg-1 col-md-2">
          <label for="">배치명</label>
        </div>
        <div class="col-lg-2 col-md-4">
          <input type="text" class="form-control" placeholder="배치파일명" />
        </div>
      </div>
      <btn-reset-search />
    </div>
